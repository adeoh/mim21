...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"src/styles/normalize.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/styles/custom.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/js/scroll.js":[function(require,module,exports) {
var define;
/**
...
(function (root, factory) {
  ...
  var reset = function reset(i, el) {
    ...
    dragged = [].slice.call(_document.getElementsByClassName('d-s'));
...
},{"./stringify":"node_modules/qs/lib/stringify.js","./parse":"node_modules/qs/lib/parse.js","./formats":"node_modules/qs/lib/formats.js"}],"node_modules/are.na/index.js":[function(require,module,exports) {
...
},{"axios":"node_modules/axios/index.js","qs":"node_modules/qs/lib/index.js"}],"src/components/gallery.js":[function(require,module,exports) {
// import "../js/loop.js";
...
module.exports = {
  render: function render(element) {
    ...
    arena.channel('folio2020').get().then(function (chan) {
      chan.contents.map(function (item) {
...
},{"are.na":"node_modules/are.na/index.js"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
window.onload = function () {
  Promise.resolve().then(function () {
    return __importStar(require('./components/id.js'));
  }).then(function (page) {
    page.render(document.getElementById("bio"));
  });
  Promise.resolve().then(function () {
    return __importStar(require('./components/content.js'));
  }).then(function (page) {
    page.render(document.getElementById("content"));
  });
  Promise.resolve().then(function () {
    return __importStar(require('./components/gallery.js'));
  }).then(function (page) {
...
},{"./styles/normalize.scss":"src/styles/normalize.scss","./styles/custom.scss":"src/styles/custom.scss","./styles/fonts.scss":"src/styles/fonts.scss","./js/scroll.js":"src/js/scroll.js","./components/id.js":"src/components/id.js","./components/content.js":"src/components/content.js","./components/gallery.js":"src/components/gallery.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
